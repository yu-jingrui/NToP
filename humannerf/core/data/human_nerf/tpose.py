...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        'Extrinsic': E,
				'img_width': W,
				'img_height': H,
				'tpose_jts' : dst_skel_joints,
				'rotation': R,
				'translation': T,
				'bbox': dst_bbox,
				'Intrinsic': K})
        destination_folder = '/home/yjin/humannerf/experiments/human_nerf/h36m_multiview/S11/adventure/latest/tpose/'
        os.makedirs(destination_folder, exist_ok=True)
        filename = 'final_data.pkl'
