...
#            print(f"the bbox value is {bbox},\n {frame_name}")
...
#        print(f"candidate_mask  sum={np.sum(candidate_mask)}")
        valid_ys, valid_xs = np.where(candidate_mask)
#        print(f"valid_ys.shape={valid_ys.shape},valid_xs.shape={valid_xs.shape}")
...
#        print(f"original image is {orig_img}, \n image_path is {imagepath}")

        maskpath = os.path.join(self.dataset_path, 
                                'masks', 
                                '{}.png'.format(frame_name))
#        print(f"mask image is {maskpath}")
        alpha_mask = np.array(load_image(maskpath))
#        print(f"value is {alpha_mask}")
...
#            print(f"The value of D is this {D}")
